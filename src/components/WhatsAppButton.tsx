...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-6 h-14 w-14 rounded-full shadow-lg bg-[#25D366] hover:bg-[#20ba5a] text-white flex items-center justify-center z-50 transition-all duration-300 hover:scale-110 group"
      aria-label="Contact on WhatsApp"
      title={t("chatOnWhatsApp") || "Chat on WhatsApp"}
    >
      <WhatsAppIcon className="h-7 w-7 transition-transform group-hover:rotate-12" />
      <span className="absolute left-16 bg-black/80 text-white text-xs py-1.5 px-3 rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none hidden md:block">
